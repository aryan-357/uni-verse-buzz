...
import { Home, MessageCircle, Users, Settings, LogOut, Search, Bell, Megaphone, User, Shield, FileText } from 'lucide-react';
...
const Navigation = () => {
  ...
  const navItems = [
    ...
    { icon: Megaphone, label: 'Official', href: '/official' },
